package ehb.maaikedupont.opdrachtwerkstuk;
...
public class LogoutHandler extends SecurityContextLogoutHandler {
    ...
    public void logout(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
        ...
        // Build the URL to log the user out of Auth0 and redirect them to the home page.
         //https://YOUR_DOMAIN/v2/logout?returnTo=http%3A%2F%2Fwww.example.com&client_id=CLIENT_ID


        String logoutUrl = "https://maaikedupont.eu.auth0.com/v2/logout?&returnTo=https://localhost:8181&client_id=FymKNr3c0ORUoKrVMwR0h4STeRgGRH5X";
